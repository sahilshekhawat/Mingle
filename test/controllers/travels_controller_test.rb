...
class TravelsControllerTest < ActionController::TestCase
  ...
  test "should create travel" do
    assert_difference('Travel.count') do
      post :create, travel: { datetime: @travel.datetime, from: @travel.from, medium: @travel.medium, to: @travel.to, user_id: @travel.user_id }
    end
  ...
  test "should update travel" do
    patch :update, id: @travel, travel: { datetime: @travel.datetime, from: @travel.from, medium: @travel.medium, to: @travel.to, user_id: @travel.user_id }
    assert_redirected_to travel_path(assigns(:travel))
  end
